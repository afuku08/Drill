...
public class TestDiaryButtonFrame {
    public static void main(String[] args)  {
        ...
        s2.addAffair(b = 
            new SimpleAffair(17,30,"接待","銀座", "JD.ロック三世"));
        ...
        JFrame f = new DiaryButtonFrame(new Diary[] {dia1,dia2,dia3});
        f.setVisible(true);
    }
}
